...
rgb_to_grey_vec = np.array((0.2989, 0.5870, 0.1140))
def rgb_to_grey(img):
    '''

    :param img: single image or batch of single images. format [(bs,) w,h,3]
    :return: wb single image or batch of single images. format [(bs,) w,h,1]
    '''
    return np.expand_dims(img @ rgb_to_grey_vec, -1)
